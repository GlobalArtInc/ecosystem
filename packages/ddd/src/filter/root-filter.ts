...
import { type IFilter, type IRootFilter, convertFilterSpec, isGroup } from './filter';
import { type BaseFilterSpecification } from './filter-specification.base';

export class RootFilter<T extends IFilter = IFilter> extends ValueObject<IRootFilter<T>> {
  get value() {
    return this.props;
  }
