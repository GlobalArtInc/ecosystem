...
import type { KafkaSubscribeMetadata } from "../types/platformatic-kafka.types";
...
@Injectable()
export class PlatformaticKafkaConsumerExplorer implements OnApplicationBootstrap {
  constructor(
    private readonly moduleRef: ModuleRef,
    private readonly metadataScanner: MetadataScanner,
    private readonly runner: PlatformaticKafkaConsumerRunner,
  ) {}
