...
export type KafkaMessage = Message<string, string, string, string>;

export type ParsedKafkaMessage = Omit<KafkaMessage, "value" | "key" | "headers"> & {
  value: object | string;
