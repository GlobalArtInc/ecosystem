...
This package uses [`@confluentinc/kafka-javascript`](https://github.com/confluentinc/confluent-kafka-javascript), which requires **librdkafka** to be installed on the system.
