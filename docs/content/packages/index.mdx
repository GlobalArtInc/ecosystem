...
### [NestJS etcd](/packages/nestjs-etcd)

Distributed coordination module for etcd3 with leader election and distributed locking.

**Key Features:**

- Automatic leader election with failover
- Distributed locking with TTL support
...
npm install @globalart/nestjs-etcd
